...
ActiveRecord::Schema.define(version: 20140406163943) do
  ...
  create_table "faalis_groups", force: true do |t|
    t.string   "name"
    t.datetime "created_at"
    t.datetime "updated_at"
  end

  create_table "faalis_groups_permissions", force: true do |t|
    t.integer "permission_id"
    t.integer "group_id"
  end

  create_table "faalis_permissions", force: true do |t|
    t.string   "model"
  ...
  create_table "faalis_users", force: true do |t|
